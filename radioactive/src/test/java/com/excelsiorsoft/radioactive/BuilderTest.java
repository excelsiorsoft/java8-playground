...
public class BuilderTest {
    ...
    public static class Record {
		...
		public static final com.excelsiorsoft.radioactive.Builder<Record.Builder, Record> BUILDER = com.excelsiorsoft.radioactive.Builder.buildingWith(Record.Builder::new);
